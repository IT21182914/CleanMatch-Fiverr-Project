...
const migrate =
    (mod && typeof mod.runner === 'function') ? mod.runner :
...
function makeUrl() {
    ...
    return `postgres://${encodeURIComponent(DATABASE_USER)}:${encodeURIComponent(DATABASE_PASSWORD)}@${DATABASE_HOST}:${DATABASE_PORT}/${DATABASE_NAME}?sslmode=${PGSSLMODE}`;
}
