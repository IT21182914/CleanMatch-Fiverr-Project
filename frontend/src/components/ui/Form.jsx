    ...
    return (
      <div className="space-y-1">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base px-3 py-2 sm:py-2.5 autofill-override",
            {
