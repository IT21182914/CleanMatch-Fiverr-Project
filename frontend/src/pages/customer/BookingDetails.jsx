  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span
                className={`inline-flex px-4 py-2 text-sm font-semibold rounded-full shadow-sm ${
                  isPaid
        ...
        {/* Action Buttons */}
        {(canPay || canSelectCleaner || canCancel) &&
          !isCompleted &&
          !isCancelled && (
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:ml-6">
                    {canPay && (
                      <Button
                        ...
                        className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 text-sm"
                      >
                    ...
                    {canSelectCleaner && (
                      <Button
                        ...
                        className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 text-sm"
                      >
          ...
          >
            <CardContent className="p-6">
              <div className="flex items-center">
                <div
                  className={`h-12 w-12 rounded-full flex items-center justify-center mr-4 shadow-md ${
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center text-sm text-gray-600 bg-green-50 p-3 rounded-lg">
                    ...
                    <span className="font-medium">
                      Duration:{" "}
                      {booking.durationHours || booking.duration_hours || 2}{" "}
                      hours
                    </span>
                  </div>
                </div>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {(booking.city || booking.state || booking.zipCode) && (
                      <p className="break-words text-gray-500">
                        ...
                        {booking.zipCode || booking.zip_code}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
                    ...
                    <div className="min-w-0 flex-1">
                      <h4 className="text-lg font-semibold text-gray-900 truncate">
                        ...
                        {booking.cleaner?.lastName || booking.cleaner_last_name}
                      </h4>
                      ...
                      {(() => {
                        const rating =
                          booking.cleaner?.rating || booking.cleaner_rating;
                ...
                {booking.appliedOffer && (
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg text-green-700">
                    ...
                    <span className="text-sm font-semibold">
                      -
                      {formatCurrency(
                        booking.appliedOffer.discount_amount || 0
                      )}
                    </span>
                  </div>
                )}
